...
//! ![Image of pumpkin](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
pub struct Pumpkin {
    ...
    pub roundness: f32,
    /// `orangness` is a number from 8 to 27
    pub orangeness: i32,
}
...
impl Pumpkin {
    /// Smashed pumkin is gone and can't be used for pie.
    pub fn smash(self) {}
}
...
/// This constant is for the `orangeness` field in the [`Pumpkin`] struct.
